    ...
    internal class SettingsViewModel: Base.BaseViewModel
    {
        ...
        public bool TempController
        {
            ...
            set
            {
                ...
                WeatherService.MeasureConfiguration.TemperatureUnit = _config.Temperature;
            }
        }
        ...
        public bool PrecipitationController
        {
            ...
            set
            {
                ...
                WeatherService.MeasureConfiguration.PrecipitationUnit = _config.Lenght;
            }
        }
        ...
        public bool WindController
        {
            ...
            set
            {
                ...
                WeatherService.MeasureConfiguration.WindSpeedUnit = _config.Wind;
        ...
        public bool PressureController
        {
            ...
            set
            {
                ...
                WeatherService.MeasureConfiguration.PressureUnit = _config.Pressure;
            }
        }
        ...
        public bool LanguageController
        {
            ...
            set
            {
                ...
                else _config.Culture = Cultures.UA;
